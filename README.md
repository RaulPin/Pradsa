...
- Controles de muteo, pausa de video, compartir pantalla y notas locales con preguntas guía.
...
- Cuestionario editable durante la entrevista con exportación automática en `.docx` y opción manual en texto plano.
...
### Cuestionario y exportación de notas

- El panel lateral incluye cinco preguntas base que puedes completar durante la entrevista. Ajusta el texto directamente en cada respuesta según tu flujo.
- Al cerrar la sesión se descarga automáticamente un documento `.docx` con todas las respuestas y notas adicionales.
- Los botones "Descargar respuestas" y "Descargar como nota" permiten exportar el contenido manualmente en cualquier momento.
